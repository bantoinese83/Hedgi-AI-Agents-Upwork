...
describe('TokenCounter', () => {
    let counter;
    beforeEach(() => {
        counter = new token_counter_1.TokenCounter();
    });
    afterEach(() => {
        counter.cleanup();
    });
    ...
    describe('getTokenBreakdown', () => {
        it('should provide detailed token breakdown', () => {
            ...
            const breakdown = counter.getTokenBreakdown(systemPrompt, userPrompt, completion);
            ...
            expect(breakdown.totalTokens).toBe(breakdown.systemTokens +
