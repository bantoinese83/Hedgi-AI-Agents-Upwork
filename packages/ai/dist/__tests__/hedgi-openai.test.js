...
describe('HedgiOpenAI', () => {
    ...
    describe('Cost Calculation', () => {
        it('should calculate costs correctly', () => {
            ...
            const costInfo = openai.calculateCost(tokenUsage);
    ...
    describe('JSON Mode with Retry', () => {
        ...
        it('should fail after max retries', async () => {
            ...
            await expect(openai.callWithJSONMode('smb-explainer', 'Test system prompt', 'Test user prompt', schemas_1.SMBExplainerResponseSchema, input)).rejects.toThrow('Failed to get valid response after 2 attempts');
        });
    });
    describe('Cost Tracking', () => {
        it('should track costs per agent', () => {
            ...
            openai.logCost('smb-explainer', costInfo, { transactions: [] });
            openai.logCost('smb-explainer', costInfo, { transactions: [] });
...
//# sourceMappingURL=hedgi-openai.test.js.map