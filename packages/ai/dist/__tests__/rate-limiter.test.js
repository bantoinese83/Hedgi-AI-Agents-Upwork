...
describe('Default rate limiter', () => {
    it('should be available and functional', () => {
        expect(rate_limiter_1.defaultRateLimiter).toBeInstanceOf(rate_limiter_1.RateLimiter);
        expect(rate_limiter_1.defaultRateLimiter.isAllowed('test-client')).toBe(true);
    });
    it('should have correct default configuration', () => {
        // Create a fresh rate limiter with default config
        const freshRateLimiter = new rate_limiter_1.RateLimiter({
